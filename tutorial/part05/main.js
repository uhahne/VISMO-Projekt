...
function init()
{
    ...
    points.push(new THREE.Vector3(cameraRight.position.x, cameraRight.position.y, cameraRight.position.z));
    
    // THREE.Line ( THREE.BufferGeometry, THREE.LineBasicMaterial ) - rendered with gl.LINE_STRIP
    const lineGeometry = new THREE.BufferGeometry().setFromPoints(points);
    
    const lineMaterial = new THREE.LineBasicMaterial( { color: 0x1020ff } );
