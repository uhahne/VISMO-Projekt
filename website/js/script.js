...
function showLeftCameraParameters(_point) {
  ...
  document.getElementById("leftCamPrincipalPointX").value =
    cameraLeft.principalPoint.x;
  document.getElementById("leftCamPrincipalPointY").value =
    cameraLeft.principalPoint.y;
  document.getElementById("leftCamPrincipalPointZ").value =
    cameraLeft.principalPoint.z;
  ...
  document.getElementById("leftAspectRatio").innerHTML =
    cameraLeft.aspect.toFixed(3);
...
function showRightCameraParameters(_point) {
  ...
  document.getElementById("rightAspectRatio").innerHTML =
    cameraRight.aspect.toFixed(3);
...
document
  .getElementById("leftCamCoordX")
  .addEventListener("change", handleChangeCameraLeftPositionX);
...
document
  .getElementById("leftcamCoordY")
  .addEventListener("change", handleChangeCameraLeftPositionY);
...
document
  .getElementById("leftCamCoordZ")
  .addEventListener("change", handleChangeCameraLeftPositionZ);
...
document
  .getElementById("leftFieldOfView")
  .addEventListener("change", handleChangeCameraLeftFOV);
...
*/
document
  .getElementById("leftNearPlane")
  .addEventListener("change", handleChangeCameraLeftNearPlane);
...
document
  .getElementById("rightCamCoordX")
  .addEventListener("change", handleChangeCameraRightPositionX);
...
document
  .getElementById("rightCamCoordY")
  .addEventListener("change", handleChangeCameraRightPositionY);
...
document
  .getElementById("rightCamCoordZ")
  .addEventListener("change", handleChangeCameraRightPositionZ);
...
document
  .getElementById("rightFieldOfView")
  .addEventListener("change", handleChangeCameraRightFOV);
...
*/
document
  .getElementById("rightNearPlane")
  .addEventListener("change", handleChangeCameraRightNearPlane);
...
document
  .getElementById("deleteLine")
  .addEventListener("click", handleDeleteLine);
...
document
  .getElementById("pointCoordX")
  .addEventListener("change", handleChangePointPositionX);
...
document
  .getElementById("pointCoordY")
  .addEventListener("change", handleChangePointPositionY);
...
document
  .getElementById("pointCoordZ")
  .addEventListener("change", handleChangePointPositionZ);
